    ...
    return (
        <div className="text-white min-h-screen">
            ...
            <div className="relative mt-1 h-[70vh] bg-cover bg-center flex items-end" style={{ backgroundImage: `url(https://image.tmdb.org/t/p/original${movie.backdrop_path})` }}>
                ...
                <div className="relative z-10 flex items-end w-full max-w-7xl mx-auto p-6 lg:px-4 2xl:px-0 gap-3 md:gap-6">
                    <img
                        className="w-20 md:w-48 lg:w-64 rounded-lg shadow-lg"
                        src={`https://image.tmdb.org/t/p/w500${movie.poster_path}`}
                        alt={movie.title}
                    />
                    <div className="space-y-4">
                        <h1 className="text-2xl md:text-3xl lg:text-5xl font-bold">{movie.title}</h1>
                        <div className="flex flex-wrap gap-2 md:gap-4 text-sm text-gray-300">
            ...
            <section className="flex flex-col max-w-7xl mx-auto px-4 py-8 lg:px-4 2xl:px-0">
